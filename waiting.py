...
# while True:
#     if enter_list[0][0]<=current_time:
#         enter_time,id,cunsulting_time = enter_list.pop(0)
#         q.put([-cunsulting_time,id,enter_time])
#     else:
#         break

# while True:
#     cunsulting_time,id,entered_time =q.get()
#     cunsulting_time=-cunsulting_time
#     # 상담종료
#     if cunsulting_time<=10:
#         current_time+=cunsulting_time
#         answer.append(id)
...
#     # 현재시간보다 입장시간이 빠른애가 없으면
    
#     while True:
#         if enter_list and enter_list[0][0]<=current_time:
#             enter_time,id,cunsulting_time = enter_list.pop(0)
#             q.put([-cunsulting_time,id,enter_time])
#         else:
#             break
